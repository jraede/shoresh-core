define ['jquery', 'core/file/html5upload/fileCollection', 'core/file/html5upload/fileCollectionView', 'backbone'], ($, UploadFileCollection, UploadFileCollectionView, Backbone) ->
	class Uploader
